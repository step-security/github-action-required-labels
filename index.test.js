...
describe("Required Labels", () => {
  ...
  beforeEach(() => {
    ...
    // The subscription check POSTs to the StepSecurity API. Mock it so tests
    // never make a real network call (axios does not use undici's dispatcher,
    // so mockAgent.disableNetConnect() does not intercept it).
